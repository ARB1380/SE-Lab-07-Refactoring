...
//    }
    ...
    public void call() {
        ...
        Address temp = Address.createTempAddress(memory, t);
        ss.push(temp);
...
//        }
    ...
    public void add() {
        Address temp = Address.createTempAddress(memory, varType.Int);
        Address s2 = ss.pop();
        Address s1 = ss.pop();
...
//        memory.saveMemory();
    ...
    public void equal() {
        Address temp = Address.createTempAddress(memory, varType.Bool);
        Address s2 = ss.pop();
        Address s1 = ss.pop();
        if (s1.varType != s2.varType) {
